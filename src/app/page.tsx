  ...
  return (
    <PageShell>
      <PageContainer>
        ...
        {/* Sign-in prompt — unauthenticated only */}
        {authLoaded && !email && (
          <div className="mt-10 flex flex-col items-center gap-6 rounded-[28px] border border-dashed border-stone-300 bg-white/60 px-8 py-12 text-center">
            <div>
              <p className="text-xl font-semibold text-stone-800">Sign in to start your wine journey</p>
              <p className="mt-2 text-sm text-stone-500">
                Track bottles, capture tasting notes, and build your cellar — all in one place.
              </p>
            </div>
            <button
              type="button"
              onClick={signInWithGoogle}
              className="inline-flex items-center gap-2.5 rounded-2xl bg-stone-900 px-6 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-stone-700"
            >
              {/* Google "G" logo */}
